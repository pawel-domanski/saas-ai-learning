  ...
  const handleComplete = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        try {
          console.log('Tracking AI-Guides document completion:', guideId, documentId);
          posthog.capture('aiguides_document_completed', { 
            guideId, 
            documentId,
        ...
        console.error('Failed to mark AI-Guides document as read');
      }
    } catch (err) {
      console.error(err);
    } finally {
